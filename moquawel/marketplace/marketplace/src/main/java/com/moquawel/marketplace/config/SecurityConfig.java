package com.moquawel.marketplace.config;

import com.moquawel.marketplace.utils.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/v1/marketplace/**"};
